...
var datos= '<%= session.getAttribute("datos")%>';
var remplazado=datos.replace("[", "");
var remplazado2=remplazado.replace("]", "");
var parts = remplazado2.split(", ");

var horas= '<%= session.getAttribute("horas")%>';
var remplazadoh=horas.replace("[", "");
var remplazadoh2=remplazadoh.replace("]", "");
var partsh = remplazadoh2.split(", ");




for(var i = 0; i<partsh.length; i++){
	obj2={"time": partsh[i],
		    "total": parts[i]};
	data.push(obj2);
}
